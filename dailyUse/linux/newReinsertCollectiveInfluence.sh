...
then
    ...
    echo './newReinsertCollectiveInfluence.sh <networkPath> <ballRadius> <batchSize> <whetherOutputLimitedNode>'
...
../../bin/ComplexCi $networkPath $ballRadius $batchSize 500 10 0.01 $whetherOutputLimitedNode
