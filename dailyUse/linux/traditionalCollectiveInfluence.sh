...
then
	networkPath=$1
    ballRadius=$2
	whetherOutputLimitedNode=$3
else
    echo './traditionalCollectiveInfluence.sh <networkPath> <ballRadius> <whetherOutputLimitedNode>'
...
../../bin/ComplexCi $networkPath $ballRadius 1 500 1 0.01 $whetherOutputLimitedNode
