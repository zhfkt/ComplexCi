...
if %argC% LSS 4  (
	...
	echo.
	echo newReinsertCollectiveInfluence.cmd [networkPath] [ballRadius] [updateBatch] [isPrintMinPointCausingMinComponent]
	echo.
	...
	echo.
	echo Example: newReinsertCollectiveInfluence.cmd \home\network\model1.csv 2 500 1
...
..\..\x64\Release\ComplexCi %networkPath% %ballRadius% %updateBatch% 500 10 0.01 %isPrintMinPointCausingMinComponent%